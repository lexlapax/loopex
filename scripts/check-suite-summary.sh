...
expect green '1 doctest, 5 tests, 0 failures'
expect green '2 properties, 3 tests, 0 failures, 1 excluded'
expect green '1 doctest, 1 test, 0 failures, 1 skipped'
expect red 'Result: 0/1 passed'
expect red 'Result: 3 passed, 1 failed'
expect red 'Result: 3 passed, 2 excluded, extra words'
expect red '2 properties, 1 test, 1 failure'
