...
1. checks the eleven `M2` operator features, the supporting tool-registry and
   stream-owner mechanisms, and the attended demonstration, the supporting checks sitting
...
| SHA-256 | Path |
| --- | --- |
| `508c2090f78be73fe8718cd214b68f705a2c3bb53aeea81269d7eb63f870f099` | `scripts/check-m2-gate.sh` |
...
| 15 | the eleven protected `M2` outcomes, the supporting registry and stream-mechanics roles, and both demonstration roles through the standalone channel | Exact names, states, and minima below hold |
...
1–11, the supporting registry and stream-mechanics roles, and both demonstration roles. Excluded tests
