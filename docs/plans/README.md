...
**Revision status:** Pre-implementation planning; active milestone `M1` is open; no next candidate is recorded.
...
| `M1` | Open | [concept](M1.md) | [technical depth](M1-technical.md) | [gate](M1-gate.md) |
