...
| Authorized work | Implementation inside the accepted `M1` envelopes and its locked gate; no other product implementation |
...
| `M1` | Accepted | [concept](M1.md) | [technical depth](M1-technical.md) | [gate](M1-gate.md) |
