...
M2's own locked roles — the eleven Outcomes, the supporting tool-registry,
tool-schema, and stream-mechanics roles, and the attended demonstration's two roles; a test reported excluded never
