...
`history_anchoring_test.exs` at minimum 23 — and names between them the cases
that prove the real history reader carries the canonical register and refuses a
laundered prerequisite, that a completed Acceptance row is judged even while the
