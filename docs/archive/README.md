...
| `M4.md`, `M4-technical.md`, `M4-gate.md` | Unopened headless external-consumer draft, revised under the current maintainer request to reuse M3's skills and add core interactions, artifact ranges and the protocol. It has no register row or implementation authority. Its previous debt/protocol split remains at `d0699b6dc636c7e74b95082d0d8241968381927d`. Opening requires the permitted predecessor base, moving the triple into docs/plans, complete executable readiness and fresh review. [ADR 0023](../adr/0023-experimental-public-session-protocol.md#concept) owns the protocol; [ADR 0024](../adr/0024-durable-interaction-lifecycle-and-host-policy-authority.md#concept) belongs to M4. Its superseded live runner/fixtures are removed; retain their bytes at `ba51d1898bcca109a5ed32a8cc3ba831323113a1` and rebuild only when opening. |
