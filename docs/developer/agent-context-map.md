...
| Transactions, operations, recovery, cancellation | [Recovery truth](../vision.md#concept-vision-recovery-truth) | [Transaction and recovery mechanics](../vision-technical.md#technical-vision-recovery-truth) | `commit_unknown`, operation lifecycle, reconciliation, outcome algebra. For the Open M3 candidate, also load the Proposed [ADR 0025 acquisition decision](../adr/0025-resource-packs-and-skill-admission.md#concept-adr-0025-decision) and its [exact administrative effect mechanics](../adr/0025-resource-packs-and-skill-admission-technical.md#technical-adr-0025-decision): a durable host pre-submit intent plus deterministic pre-child snapshot-binding transaction, acquisition-version CAS, retained reconciliation responses and responder supersession. It is review material until accepted. |
...
| Journal, stores, branches, compaction, artifacts | [Sessions and storage](../vision.md#concept-vision-sessions-storage) | [Storage mechanics](../vision-technical.md#technical-vision-sessions-storage) | Recovery surfaces, private adapters, store decision, protection. For Open M3 acquisition work, also load Proposed [ADR 0025](../adr/0025-resource-packs-and-skill-admission.md#concept) and its [technical contract](../adr/0025-resource-packs-and-skill-admission-technical.md#technical-adr-0025-decision) for snapshot and acquisition Store transactions, the hand ledger and retained responses, source-runtime-qualified provenance generations, the bounded CLI recovery locator, retained snapshots and rollback-root pairing. |
...
| Context pipeline | [Model boundary](../vision.md#concept-vision-model-boundary) | [Context-pipeline mechanics](../vision-technical.md#technical-vision-model-boundary) | The sole seam for memory, retrieval, prompts, provenance, and receipts. Proposed [ADR 0025](../adr/0025-resource-packs-and-skill-admission.md#concept) owns Open M3's canonical resource blocks, revision-3 receipt, admission ordering, complete four-member launch envelope, durable binding intent, zero-or-one bound snapshot, separate fresh current attestation, changed-source recovery-only state and fresh-runtime use contract. |
...
| Executors, brain/hand, distribution | [Executor protocol](../vision.md#concept-vision-executor-protocol) | [Executor mechanics](../vision-technical.md#technical-vision-executor-protocol) | Job/receipt protocol, trust classes and trusted gateways. Proposed [ADR 0025](../adr/0025-resource-packs-and-skill-admission-technical.md#technical-adr-0025-decision) is Open M3's bounded ADR 0007, Concept-vision section 15 and Technical-vision sections 6.3/8.4/9.3/9.4/15.1/23.3 refinement for one tagged runtime-control acquisition hand, with separate original-attempt and current-responder identities, safe fixed-parent creation and staging outside discovery. Session epoch/origin remains mandatory for session-owned effects; existing session `JobRequest`, grant, event, receipt, reconciliation and oracle behavior remains unchanged and needs same-runtime coexistence proof. |
| Trust, resources, sensitive data | [Sensitive data](../vision.md#concept-vision-sensitive-data) | [Trust mechanics](../vision-technical.md#technical-vision-sensitive-data) | Resource admission, tenancy, credentials and redaction. The Open M3 candidate's Proposed [resource-pack decision](../adr/0025-resource-packs-and-skill-admission.md#concept) fixes public anonymous Git acquisition, canonical-or-nil secret-free workspace origin, project-only discovery, operator-only admission, and a fresh runtime/trust decision after installation if accepted. |
