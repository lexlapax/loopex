...
| Public protocol, events, attachments | [Public protocol](../vision.md#concept-vision-public-protocol) | [Protocol mechanics](../vision-technical.md#technical-vision-public-protocol) | Stream planes, envelopes, attach behavior, and authority boundaries; the headless protocol proposal is [ADR 0023](../adr/0023-experimental-public-session-protocol.md#concept); [ADR 0024](../adr/0024-durable-interaction-lifecycle-and-host-policy-authority.md#concept) places durable interactions in M4 core before wire mapping. Both are accepted prerequisites of the accepted [`M4` plan](../plans/M4.md#concept); the [M4 pre-acceptance choices](#disposition-m4-preacceptance-contract-choices-2026-09-13) record their selected profiles. The Open [`M5` plan](../plans/M5.md#concept) proposes [ADR 0032](../adr/0032-daemon-attachment-residency-and-replay.md#concept) for the daemon socket transport, generation-2 methods and attachment residency, and [ADR 0033](../adr/0033-collaboration-controller-lease-and-takeover.md#concept) for the controller lease, observers and takeover above core; both remain Proposed. |
| Journal, stores, branches, compaction, artifacts | [Sessions and storage](../vision.md#concept-vision-sessions-storage) | [Storage mechanics](../vision-technical.md#technical-vision-sessions-storage) | Recovery surfaces, private adapters, store decision, protection. [ADR 0028](../adr/0028-bounded-artifact-retrieval.md#concept) is the accepted M4 transfer contract with its [selected profile](#disposition-m4-preacceptance-contract-choices-2026-09-13). The Open [`M5` plan](../plans/M5.md#concept) proposes [ADR 0031](../adr/0031-daemon-grade-store-selection-and-migration.md#concept), which selects the existing local adapter for the M5 daemon with its documented limits and reserves the daemon-grade adapter and its one-way migration for the successor milestone; it remains Proposed. |
