...
| [Compatibility surfaces](compatibility-surfaces.md#concept) | Every surface the current milestone touches, why none is labelled or frozen, and what that means for an embedder. |
