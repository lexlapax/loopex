# Loopex — Founding Vision: Technical Depth

<a id="technical-depth"></a>
## Technical depth

Concept: [Loopex founding vision](vision.md#concept)
...
<a id="technical-vision-purpose-authority"></a>
## 1. Purpose and authority

Concept: [Purpose and authority](vision.md#concept-vision-purpose-authority)

This document and its [concept companion](vision.md#concept) jointly form the
founding vision for the Loopex repository at
[github.com/lexlapax/loopex](https://github.com/lexlapax/loopex). This companion defines
...
The pair is a north-star and boundary document. It is not itself a frozen wire
...
4. this founding vision pair;
5. historical plans and archived design material.

An ADR may refine this vision pair. A release plan may select a subset of it. Neither
...
<a id="technical-vision-executive-thesis"></a>
## 2. Executive thesis

Concept: [Executive thesis](vision.md#concept-vision-executive-thesis)
...
<a id="technical-vision-product-definition"></a>
## 3. Product definition

Concept: [Product definition](vision.md#concept-vision-product-definition)
...
8. **Practical implementation learning material.** Every architectural promise
...
<a id="technical-vision-product-principles"></a>
## 4. Product principles

Concept: [Product principles](vision.md#concept-vision-product-principles)

These principles are the compact product non-negotiables carried by
`AGENTS.md`.
...
<a id="technical-vision-domain-language"></a>
## 5. Stable domain language

Concept: [Stable domain language](vision.md#concept-vision-domain-language)
...
<a id="technical-vision-ownership-trust"></a>
## 6. Ownership and trust boundaries

Concept: [Ownership and trust boundaries](vision.md#concept-vision-ownership-trust)
...
<a id="technical-vision-dependency-doctrine"></a>
## 7. The Loopex stack and dependency doctrine

Concept: [Stack and dependency doctrine](vision.md#concept-vision-dependency-doctrine)
...
<a id="technical-vision-runtime-supervision"></a>
## 8. Runtime instances and supervision

Concept: [Runtime instances and supervision](vision.md#concept-vision-runtime-supervision)
...
Concept: [Transaction, operation, and recovery truth](vision.md#concept-vision-recovery-truth)
...
<a id="technical-vision-loop-semantics"></a>
## 10. Agent-loop semantics

Concept: [Loop semantics](vision.md#concept-vision-loop-semantics)
...
<a id="technical-vision-public-protocol"></a>
## 11. Public protocol and channel semantics

Concept: [Public protocol and channel semantics](vision.md#concept-vision-public-protocol)
...
<a id="technical-vision-sessions-storage"></a>
...
<a id="technical-vision-model-boundary"></a>
## 13. Model/provider boundary

Concept: [Model and context boundary](vision.md#concept-vision-model-boundary)
...
<a id="technical-vision-tools"></a>
## 14. Tools and the coding surface

Concept: [Tools and the coding surface](vision.md#concept-vision-tools)
...
<a id="technical-vision-executor-protocol"></a>
## 15. Executor protocol and brain/hand topology

Concept: [Executor protocol and brain/hand topology](vision.md#concept-vision-executor-protocol)
...
<a id="technical-vision-sensitive-data"></a>
## 16. Trust, sensitive data, and project resources

Concept: [Trust, sensitive data, and project resources](vision.md#concept-vision-sensitive-data)
...
<a id="technical-vision-extensions"></a>
## 17. Trusted extensions and generated code

Concept: [Trusted extensions and generated code](vision.md#concept-vision-extensions)
...
<a id="technical-vision-api-transports"></a>
## 18. Embedded API, transports, and clients

Concept: [Embedded API, transports, and clients](vision.md#concept-vision-api-transports)
...
<a id="technical-vision-hosts"></a>
## 19. Future hosts and ecosystem posture

Concept: [Hosts and ecosystem posture](vision.md#concept-vision-hosts)
...
<a id="technical-vision-repository-seed"></a>
## 20. Repository seed

Concept: [Repository seed](vision.md#concept-vision-repository-seed)
...
The derived AGENTS file should carry only rules required during implementation:
reading and authority order, dependency direction,
...
The repository should become practical, directly inspectable learning material
for Elixir development and the Loopex runtime. The paired
[development charter](developer/development-charter-technical.md#technical-depth)
owns the exact classification, anchor, reciprocal-link, report, review, and
code-documentation mechanics; `AGENTS.md` owns their required development
behavior. In particular:

- substantive concept documents have paired Technical depth companions and
  form one authority and review unit;
- every concept that needs implementation or proof depth links a stable exact
  companion anchor, and that technical section links back;
- technical depth may prove or constrain a stated concept but may not introduce
  hidden scope or a decision;
- modules, behaviours, callbacks, public APIs, public types, and important
  boundaries document `## Concept` before `## Technical depth`;
- private paired comments are reserved for a non-obvious invariant, effect,
  failure mode, or decision; and
- indexes, setup and operator runbooks, status and evidence records, executable
  contracts, configuration, source, and immutable archives remain explicit
  unpaired exceptions and may not become hidden decision surfaces.

The content itself remains concrete:
...
<a id="technical-vision-delivery-strategy"></a>
## 21. Delivery strategy

Concept: [Delivery strategy](vision.md#concept-vision-delivery-strategy)
...
| Useful local kernel | Can a developer use a small, durable, truthful coding loop through the embedded API and reference client? |
...
<a id="technical-vision-serial-barriers"></a>
## 22. Ownership and serial barriers

Concept: [Ownership and serial barriers](vision.md#concept-vision-serial-barriers)
...
<a id="technical-vision-verification"></a>
## 23. Verification and acceptance philosophy

Concept: [Verification and acceptance](vision.md#concept-vision-verification)
...
<a id="technical-vision-compatibility"></a>
## 24. Compatibility and release governance

Concept: [Compatibility and release governance](vision.md#concept-vision-compatibility)
...
<a id="technical-vision-risks"></a>
## 25. Risks and countermeasures

Concept: [Risks and countermeasures](vision.md#concept-vision-risks)
...
| A plain-text local store becomes an accidental public database | Explicit experimental private adapter; crash contract; stable archive format separate. |
...
Concept: [Current founding decisions](vision.md#concept-vision-founding-decisions)
...
<a id="technical-vision-name-license"></a>
## 28. Name and license

Concept: [Name and license](vision.md#concept-vision-name-license)
...
<a id="technical-vision-sources"></a>
## 29. Informative design sources

Concept: [Informative design sources](vision.md#concept-vision-sources)
...
<a id="technical-vision-closing-thesis"></a>
## 30. Closing thesis

Concept: [Closing thesis](vision.md#concept-vision-closing-thesis)
